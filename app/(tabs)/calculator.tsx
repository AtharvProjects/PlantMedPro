      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 130 }} showsVerticalScrollIndicator={false}>
        ...
        {showResult && totalArea > 0 && (
          <View style={{ marginHorizontal: 20, marginBottom: 20 }}>
            ...
            <TouchableOpacity
              onPress={() => Alert.alert('Saved!', 'Dosage instructions saved offline for reference.')}
              ...
              <IconSymbol name="arrow.down.doc.fill" size={18} color="white" />
              <Text style={{ color: 'white', fontWeight: '800', fontSize: 15 }}>Save Instructions Offline</Text>
            </TouchableOpacity>
          </View>
        )}
      </ScrollView>
